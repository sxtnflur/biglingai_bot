...
<i>Выбери формат, в котором я буду с тобой общаться:</i>
(<code>🖊️ Текст</code> | <code>🗣️ Голос</code> | <code>🗣️ Голос + 🖊️ Текст</code>)

<i>а после нажми "⏩ Начать"</i>
'''

    INSTRUCTION = '''
Как только ты выберешь один из режимов, мы начнем общение
